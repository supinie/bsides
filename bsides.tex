...
\begin{frame}
    ...
    \begin{columns}[T] % [T] ensures correct vertical alignment
        \begin{column}{0.58\linewidth} % Left column
            ...
            Hawk\footfullcite{hawk} is the youngest of all schemes listed, and is currently the only lattice based scheme left in NISTs call for additional signature schemes\footfullcite{nistsig}. HAWKs biggest selling points are smaller keys and signatures compared to other signature schemes whilst maintaining the speed of lattices.
        \end{column}
