...
\begin{frame}
    ...
    \begin{columns}[T] % [T] ensures correct vertical alignment
        \begin{column}{0.42\linewidth} % Left column
            ...
            ML-KEM/DSA were both elected by NIST as schemes for standardisation, with the standards published August 2024\footfullcite{mlkem}\footfullcite{mldsa}. These are both front runners due to their speed, however their drawback is a fairly large key size. LWE is a well studied assumption, with strong worst and average case analysis.
        \end{column}
