...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.3\linewidth} % Right column
            \begin{itemize}
                \item \textbf{Acceptable}: \\Approved for use.
            \end{itemize}
        \end{column}
        \begin{column}{0.3\linewidth} % Right column
            \begin{itemize}
                \item \textbf{Deprecated}: \\Some security risk, assess before use.
            \end{itemize}
        \end{column}
        \begin{column}{0.3\linewidth} % Right column
            \begin{itemize}
                \item \textbf{Disallowed}: \\No longer allowed for stated purpose.
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
